...
exports.MeatBoilerplateElement = void 0;
...
var MeatBoilerplateElement =
/*#__PURE__*/
function (_HTMLElement) {
  _inherits(MeatBoilerplateElement, _HTMLElement);
   ...
   */
  function MeatBoilerplateElement() {
    var _this;

    _classCallCheck(this, MeatBoilerplateElement);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MeatBoilerplateElement).call(this));
  ...
  _createClass(MeatBoilerplateElement, [{
  ...
  return MeatBoilerplateElement;
}(_wrapNativeSuper(HTMLElement));

exports.MeatBoilerplateElement = MeatBoilerplateElement;
