...
export class MeatButtonElement extends HTMLElement {
   ...
   * @property {attribute} type -Enables the specified type of button.
   * @property {string} size -Changes the size of the button. Choose "small", "medium", or "large"
   * @property {string} bootstrap -Assign this attribute boostrap classes. Use this attribute to style buttons with bootstrap.
   * */
  constructor() {
    super();
    this._parentForm;
