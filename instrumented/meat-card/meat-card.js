...
`;export class MeatCard extends HTMLElement{/**
   ...
   * */constructor(){cov_181i1cjuha.f[0]++;cov_181i1cjuha.s[2]++;super();cov_181i1cjuha.s[3]++;this.shadowDOM=this.attachShadow({mode:"open"});cov_181i1cjuha.s[4]++;this.shadowDOM.appendChild(template.content.cloneNode(true));}/**
   * Live-cycle method called when the custom element is loaded, often used for initialization
   */connectedCallback(){cov_181i1cjuha.f[1]++;}/**
   * Tell the webcomponent to observe these attributes, if any of them are added, changed, or removed, then
   * call attributeChangedCallback(name, oldVal, newVal)
   */static get observedAttributes(){cov_181i1cjuha.f[2]++;cov_181i1cjuha.s[5]++;return["shadow"];}/**
   * Called whenever one of the attributes specified in observedAttributes() is changed
   * @param {string} name
   * @param {string} oldVal
   * @param {string} newVal
   */attributeChangedCallback(name,oldVal,newVal){cov_181i1cjuha.f[3]++;cov_181i1cjuha.s[6]++;switch(name){case"shadow":cov_181i1cjuha.b[0][0]++;cov_181i1cjuha.s[7]++;break;}}/**
   * Getters and Setters
   */get shadow(){cov_181i1cjuha.f[4]++;cov_181i1cjuha.s[8]++;return this.getAttribute("shadow");}set shadow(val){cov_181i1cjuha.f[5]++;cov_181i1cjuha.s[9]++;if(val){cov_181i1cjuha.b[1][0]++;cov_181i1cjuha.s[10]++;this.setAttribute("shadow",val);}else{cov_181i1cjuha.b[1][1]++;cov_181i1cjuha.s[11]++;this.removeAttribute("shadow");}}}cov_181i1cjuha.s[12]++;window.customElements.define("meat-card",MeatCard);